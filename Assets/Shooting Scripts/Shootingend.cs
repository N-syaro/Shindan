...
public class Shootingend : MonoBehaviour
{
    ...
    {
        Debug.Log("StartfadeÇ™ì«Ç›çûÇ‹ÇÍÇ‹ÇµÇΩ");
        if (isFading) return;
    ...
    {
        Debug.Log("DelayedFadeSequenceÇ™ì«Ç›çûÇ‹ÇÍÇ‹ÇµÇΩ");
        yield return new WaitForSeconds(6f);  // 6ïbë“ã@
        yield return StartCoroutine(FadeSequence());
    }
    IEnumerator FadeSequence()
    {
        Debug.Log("FadeSequenceÇ™ì«Ç›çûÇ‹ÇÍÇ‹ÇµÇΩ");
